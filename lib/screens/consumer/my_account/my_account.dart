...
class _MyAccountState extends BaseState<MyAccount> {
  ...
  AppBar _buildAppBar(BuildContext context) {
    return AppBar(
      elevation: 1,
      centerTitle: (widget.fromScreen != null &&
              widget.fromScreen == getTranslation(Strings.MY_ACCOUNTS))
          ? false
          : true,
      automaticallyImplyLeading: false,
      leading: (widget.fromScreen != null &&
              widget.fromScreen == getTranslation(Strings.MY_ACCOUNTS))
          ? IconButton(
      ...
      title: Text(
        ...
        textAlign: (widget.fromScreen != null &&
                widget.fromScreen == getTranslation(Strings.MY_ACCOUNTS))
            ? TextAlign.left
            : TextAlign.center,
  ...
  List<Widget> loadCards() {
    ...
    newList.add(Container(
      child: CustomCard(
        image: Assets.my_account_card,
        bankIcon: Assets.ic_tara,
