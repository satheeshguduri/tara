...
class _SignInScreenState extends BaseState<SignInScreen> {
  ...
  Widget getRootContainer() {
    return Obx(() => SafeArea(child: SignInFlowBg(child: getSignInWidget()))
                ...
                child: Container(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(getTranslation(Strings.dont_have_account),
                        ...
                        Expanded(
                            child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(getTranslation(Strings.SIGN_UP),
                                        style: BaseStyles
                  ...
                  child: Wrap(
                    children: <Widget>[
                      ...
                      TextWithBottomOverlay(
                        titleStr: getTranslation(Strings.login),
                      ),
                      Container(
...
//                          autoValidate:true,
                      ...
                      Container(
                        ...
                        child: Row(children: [
                          Container(
                            child: Image.asset(Assets.ic_lock,
                                color: AppColors.light_grey_blue),
                            height: 24,
                            width: 24,
