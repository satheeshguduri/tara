...
abstract class OrderRepository {
  ...
  Future<Either<Failure, List<OrderResponse>>> getOrdersByMerchantId(
      int merchantId);
  Future<Either<Failure, List<OrderResponse>>> getOrdersByConsumerId(
      int consumerId);
  ...
  Future<Either<Failure, AddProductsResponse>> addProduct(List<Item> items);
  Future<Either<Failure, GetProductResponse>> getProducts(int page, int size);
