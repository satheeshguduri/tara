...
abstract class TransactionRepository {
  Future<Either<Failure, PaymentResponse>> initiateTaraTransaction(
      TransactionModel transactionModel); //while initiating the transaction
  Future<Either<Failure, BaseResponse>> updateTaraTransaction(
      TransactionModel transactionModel); //on Successful transaction

  Future<Either<Failure, List<BankDetailsBean>>> getBanksList(
      CommonRegistrationRequest commonRegistrationRequest);
  Future<Either<Failure, TrackAccountDetailsResponse>>
  ...
  Future<Either<Failure, TrackAccountDetailsResponse>>
      trackDeleteAccountDetailsRequest(
    CommonRegistrationRequest commonRegistrationRequest,
  );
  Future<Either<Failure, TrackAccountDetailsResponse>>
      initiateAccountDetailsRequest(
          AccountDetailsRequest accountDetailsRequest);
  Future<Either<Failure, TrackAccountDetailsResponse>>
      initiateDeleteAccountRequest(DeleteAccountRequest deleteAccountRequest);
  Future<Either<Failure, TransactionResponse>> initiatePreTransactionRequest(
      PreTransactionRequest preTransactionRequest);
  Future<Either<Failure, TransactionResponse>> initiateTransactionRequest(
      TransactionRequest transactionRequest);
  Future<Either<Failure, TransactionResponse>>
      initiateMerchantTransactionRequest(TransactionRequest transactionRequest);
  Future<Either<Failure, TransactionResponse>> trackTransactionRequest(
      TrackTransactionRequest transactionRequest);

  Future<Either<Failure, SearchBeneficiaryResponse>> searchBeneficiary(
      Map<String, dynamic> queries);
  Future<Either<Failure, ValidateMobileResponse>> validateMobile(
      ValidateMobileRequest validateMobileRequest);
  Future<Either<Failure, AddBeneficiaryResponse>> addBeneficiary(
      AddBeneficiaryRequest addBeneficiaryRequest);
  Future<Either<Failure, GetBeneficiariesResponse>> getBeneficiaries(
      Map<String, dynamic> queries);
  Future<Either<Failure, AddBeneficiaryResponse>> mapBeneficiaryDetails(
      MapBeneficiaryRequest mapBeneficiaryRequest);

  Future<Either<Failure, String>> merchantLogin(String ki, String request);

  Future<Either<Failure, TransactionResponse>> payerCollectResponse(
      PayerCollectRequest payerCollectRequest);

  Future<Either<Failure, TransactionHistoryResponse>> getTxnHistory(
      Map<String, dynamic> queries);

  Future<Either<Failure, String>> getBankLogo(Map<String, dynamic> queries);

  Future<Either<Failure, RegisterCardResponse>> registerCardDetail(
      RegisterCardRequest registerCardRequest,
      String sessionKey,
      String txnId,
      String
          publickKey); //from this extract RegisterCardResponse and pass RegisterCardRequest

  Future<Either<Failure, CommonResponse>> confirmAccountRegistration(
      ConfirmAccountRegistrationRequest commonRequest,
      String sessionKey,
      String txnId); // pass ConfirmAccountRegistrationRequest

  Future<Either<Failure, RetrieveKeyResponse>> retrieveKey(
      RetrieveKeyRequest retrieveKeyRequest,
      TransactionType transactionType,
      String
          transactionId); //from this extract RetrieveKey Response and pass RetrieveKey request

  Future<Either<Failure, CommonResponse>> authorize(
      AuthorizeRequest authorizeRequest,
      TransactionType transactionType,
      String sessionKey,
      String transactionId); // pass ValidateOTPRequest

  Future<Either<Failure, FetchOtpResponse>> fetchOtp(
      FetchOtpRequest fetchOtpRequest,
      TransactionType transactionType,
      String sessionKey,
      String
          transactionId); // pass FetchOTPRequest and extract FetchOTP Response

  Future<Either<Failure, FetchOtpResponse>> refreshOtp(
      RefreshOtpRequest refreshOtpRequest,
      TransactionType transactionType,
      String sessionKey,
      String
          transactionId); // pass RefreshOTPRequest and extract FetchOTPResponse

  Future<Either<Failure, CommonResponse>> validateOtp(
      ValidateOtpRequest validateOtpRequest,
      TransactionType transactionType,
      String sessionKey,
      String transactionId); // pass ValidateOTPRequest

  Future<Either<Failure, CommonResponse>> retrieveAndAuthorize(
      CommonRequest commonRequest); // pass ValidateOTPRequest
...
class TransactionRepositoryImpl implements TransactionRepository {
  ...
  TransactionRepositoryImpl(
      ...
      this.pspRemoteDataSource,
      this.umpsRemoteDataSource);
  ...
  Future<Either<Failure, BaseResponse>> updateTaraTransaction(
    ...
    token = user.securityToken.token.tara.bearer();
    try {
      var response = await remoteDataSource.updateSendRequest(
          token, transactionModel.transactionId, transactionModel);
      return Right(response);
    } catch (e) {
      return Left(Failure.fromServerError(e));
    }
  ...
  Future<Either<Failure, AddBeneficiaryResponse>> addBeneficiary(
    ...
    try {
      var response =
          await pspRemoteDataSource.addBeneficiary(addBeneficiaryRequest);
      return Right(response);
    } catch (e) {
      return Left(Failure.fromServerError(e));
    }
  ...
  @override
  Future<Either<Failure, CommonResponse>> confirmAccountRegistration(
      ConfirmAccountRegistrationRequest confirmAccountRegistrationRequest,
      String sessionKey,
      String txnId) async {
    try {
      var deviceRegInfo =
          await getIt.get<SessionLocalDataStore>().getDeviceRegInfo();
      var data = await CryptoHelper().encryptDataWithRandomKey(
          json.encode(confirmAccountRegistrationRequest.toJson()),
          sessionKey,
          false);
      var symmetricKey = data['symmetricKey'];
      var encryptedBody = data['encryptedData'];
      print("SymmetricKey==>" + symmetricKey);
      var commonRequestBean = await BaseRequestHelper().getCommonRequestBean(
          TransactionType.REGISTER_CARD_ACC_DETAIL, symmetricKey);
      ...
      var response =
          await umpsRemoteDataSource.confirmAccountRegistration(commonRequest);
  ...
  @override
  Future<Either<Failure, String>> getBankLogo(
      Map<String, dynamic> queries) async {
    try {
      var response = await pspRemoteDataSource.getBankLogo(queries);
      return Right(response);
    } catch (e) {
      return Left(Failure.fromServerError(e));
    }
  ...
  Future<Either<Failure, List<BankDetailsBean>>> getBanksList(
    ...
    try {
      var response =
          await pspRemoteDataSource.getBanksList(commonRegistrationRequest);
      return Right(response);
    } catch (e) {
      return Left(Failure.fromServerError(e));
    }
  ...
  @override
  Future<Either<Failure, TransactionResponse>> initiatePreTransactionRequest(
      PreTransactionRequest preTransactionRequest) async {
    try {
  ...
  @override
  Future<Either<Failure, TransactionResponse>>
      initiateMerchantTransactionRequest(
          TransactionRequest transactionRequest) async {
    try {
      var response = await pspRemoteDataSource
  ...
  Future<Either<Failure, RetrieveKeyResponse>> retrieveKey(
    ...
    try {
      var deviceRegInfo =
          await getIt.get<SessionLocalDataStore>().getDeviceRegInfo();
      var data = await CryptoHelper().encryptDataWithRandomKey(
          json.encode(retrieveKeyRequest.toJson()),
          deviceRegInfo.splKey,
          false);
      var symmetricKey = data['symmetricKey'];
      var encryptedBody = data['encryptedData'];
      var commonRequestBean = await BaseRequestHelper()
          .getCommonRequestBean(transactionType, symmetricKey);
      ...
      if (response?.commonResponse?.symmetricKey?.isNotEmpty ?? false) {
        var decryptedBody = await CryptoHelper().decryptDataWithSymmetricKey(
            response.encryptionKeyRetrievalResponsePayloadEnc,
            response?.commonResponse?.symmetricKey,
            deviceRegInfo.splKey,
            false);
        var finalResponse =
            RetrieveKeyResponse.fromJson(jsonDecode(decryptedBody));
  ...
  Future<Either<Failure, CommonResponse>> authorize(
    ...
    try {
      var deviceRegInfo =
          await getIt.get<SessionLocalDataStore>().getDeviceRegInfo();
      var data = await CryptoHelper().encryptDataWithRandomKey(
          json.encode(authorizeRequest.toJson()), sessionKey, false);
      var symmetricKey = data['symmetricKey'];
      var encryptedBody = data['encryptedData'];
      var commonRequestBean = await BaseRequestHelper()
          .getCommonRequestBean(transactionType, symmetricKey);
  ...
  Future<Either<Failure, FetchOtpResponse>> fetchOtp(
    ...
    try {
      var deviceRegInfo =
          await getIt.get<SessionLocalDataStore>().getDeviceRegInfo();
      var data = await CryptoHelper().encryptDataWithRandomKey(
          json.encode(fetchOtpRequest.toJson()), deviceRegInfo.splKey, false);
      var symmetricKey = data['symmetricKey'];
      var encryptedBody = data['encryptedData'];
      ...
      if (response?.commonResponse?.symmetricKey?.isNotEmpty ?? false) {
        var decryptedBody = await CryptoHelper().decryptDataWithSymmetricKey(
            response.fetchOtpCodeResponsePayloadEnc,
            response?.commonResponse?.symmetricKey,
            deviceRegInfo.splKey,
            false);
        var finalResponse =
            FetchOtpResponse.fromJson(jsonDecode(decryptedBody));
        return Right(finalResponse);
      }
  ...
  Future<Either<Failure, FetchOtpResponse>> refreshOtp(
    ...
    try {
      var deviceRegInfo =
          await getIt.get<SessionLocalDataStore>().getDeviceRegInfo();
      var data = await CryptoHelper().encryptDataWithRandomKey(
          json.encode(refreshOtpRequest.toJson()), deviceRegInfo.splKey, false);
      var symmetricKey = data['symmetricKey'];
      var encryptedBody = data['encryptedData'];
      var commonRequestBean = await BaseRequestHelper()
          .getCommonRequestBean(transactionType, symmetricKey);
  ...
  Future<Either<Failure, CommonResponse>> validateOtp(
    ...
    try {
      ...
      var deviceRegInfo =
          await getIt.get<SessionLocalDataStore>().getDeviceRegInfo();
      var data = await CryptoHelper().encryptDataWithRandomKey(
          json.encode(validateOtpRequest.toJson()), sessionKey, false);
      var symmetricKey = data['symmetricKey'];
      var encryptedBody = data['encryptedData'];
      var commonRequestBean = await BaseRequestHelper()
          .getCommonRequestBean(transactionType, symmetricKey);
  ...
  Future<Either<Failure, RegisterCardResponse>> registerCardDetail(
      ...
      String sessionKey,
      String txnId,
      String publickKey) async {
    try {
      var deviceRegInfo =
          await getIt.get<SessionLocalDataStore>().getDeviceRegInfo();
      var data = await CryptoHelper().encryptDataWithRandomKey(
          json.encode(registerCardRequest.toJson()), sessionKey, false);
      var symmetricKey = data['symmetricKey'];
      var encryptedBody = data['encryptedData'];
      var commonRequestBean = await BaseRequestHelper().getCommonRequestBean(
          TransactionType.REGISTER_CARD_ACC_DETAIL, symmetricKey);
      ...
      var response =
          await umpsRemoteDataSource.registerCardDetail(commonRequest);
      print(jsonEncode(response));
      if (response?.commonResponse?.symmetricKey?.isNotEmpty ?? false) {
        var decryptedBody = await CryptoHelper().decryptDataWithPublicKey(
            response.registerCardDetailResponsePayloadEnc,
            response?.commonResponse?.symmetricKey,
            deviceRegInfo.splKey,
            false,
            publickKey);
        var finalResponse =
            RegisterCardResponse.fromJson(jsonDecode(decryptedBody));
        return Right(finalResponse);
      }
  ...
  Future<Either<Failure, TrackAccountDetailsResponse>>
    ...
    try {
      var response = await pspRemoteDataSource
          .trackAccountDetailsRequest(commonRegistrationRequest);
      return Right(response);
    } catch (e) {
      return Left(Failure.fromServerError(e));
    }
  ...
  @override
  Future<Either<Failure, TransactionResponse>> trackTransactionRequest(
      TrackTransactionRequest transactionRequest) async {
    try {
      var response =
          await pspRemoteDataSource.trackTransactionRequest(transactionRequest);
      return Right(response);
    } catch (e) {
      return Left(Failure.fromServerError(e));
    }
  ...
  Future<Either<Failure, ValidateMobileResponse>> validateMobile(
    ...
    try {
      var response =
          await pspRemoteDataSource.validateMobile(validateMobileRequest);
      return Right(response);
    } catch (e) {
      return Left(Failure.fromServerError(e));
    }
  ...
  @override
  Future<Either<Failure, AddBeneficiaryResponse>> mapBeneficiaryDetails(
      MapBeneficiaryRequest mapBeneficiaryRequest) async {
    try {
      var response = await pspRemoteDataSource
  ...
  @override
  Future<Either<Failure, TransactionResponse>> payerCollectResponse(
      PayerCollectRequest payerCollectRequest) async {
    try {
      var response =
          await pspRemoteDataSource.payerCollectResponse(payerCollectRequest);
      return Right(response);
    } catch (e) {
      return Left(Failure.fromServerError(e));
    }
  ...
  Future<Either<Failure, TrackAccountDetailsResponse>>
    ...
    try {
      var response = await pspRemoteDataSource
          .trackDeleteAccountDetailsRequest(commonRegistrationRequest);
      return Right(response);
    } catch (e) {
      return Left(Failure.fromServerError(e));
    }
