...
class API {
  ...
  static const DEMO_ENDPOINT =
      "http://107.20.4.43:9002/"; //DEMO endpoint should be replaced here
  ...
  static const customer_profile_by_firebase_id =
      "v1/tara/crm/customer/firebase";
  static const get_toaddress = "v1/tara/auth";

  //Order Related API's

  static const get_orders_consumers =
      "v0.1/tara/erp/consumer/{consumerId}/order";
  static const get_orders_merchants =
  ...
  static const get_tokenization_details =
      "v0.1/mcpayment/detail/tokenization/{registerId}";
  static const delete_tokenization_card =
      "v0.1/mcpayment/delete/token/{registerId}";
  static const get_mc_payment = "v0.1/mcpayment/request/payment";
  static const get_mc_payment_by_registerId =
      "v0.1/mcpayment/detail/payment/{registerId}";
  static const get_cards_by_customer_id =
      "v0.1/mcpayment/detail/card/{customerId}";

  //Transfer API
  static const send_money = "v0.1/tara/erp/account";
  static const update_tara_transaction =
...
class PSPApi {
  ...
  static const initiate_merchant_transaction_request =
      'psp-umps-adaptor/umps-merchant/initiate-transaction-request';
  static const payer_collect_response =
      "psp-umps-adaptor/umps-app/payer-collect-response";

  //transaction history
  static const txn_history_details =
...
class UMPSCoreApi {
  ...
  static const register_card_detail =
